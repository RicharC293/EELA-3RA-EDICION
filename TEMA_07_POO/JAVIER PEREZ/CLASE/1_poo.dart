...
void main() {
  ...
  final gato = Animal("Botas", edad: 10, genero: "Hembra", color: "Amarillo", tipoDeComida: "pez");
  print(gato);

  final elefante = Animal("Sanson", edad: 4, genero: "Macho", color: "Gris", tipoDeComida:"hierba");
  print (elefante);

  final mono = Animal("Cesar",edad: 10, genero: "Macho", color: "Gris", tipoDeComida:"banana");
